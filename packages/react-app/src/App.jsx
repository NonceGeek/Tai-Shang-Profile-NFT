...
function App(props) {
  ...
  */
  // keep track of a variable from the contract in the local React state:
  const balance = useContractReader(readContracts, "TaiShangProfileNFT", "balanceOf", [address]);
    ...
    const updateYourCollectibles = async () => {
      ...
      for (let tokenIndex = 0; tokenIndex < balance; tokenIndex++) {
        try {
          ...
          const tokenId = await readContracts.TaiShangProfileNFT.tokenOfOwnerByIndex(address, tokenIndex);
          console.log("tokenId", tokenId);
          const tokenURI = await readContracts.TaiShangProfileNFT.tokenURI(tokenId);
